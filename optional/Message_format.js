...
module.exports = (rem, messageRaw) => {
    ...
    message.body = message.message.conversation || message.message[message.type].text || message.message[message.type].caption || message.message[message.type].selectedDisplayText || message.message[message.type].selectedDisplayText || message.message[message.type].description || message.message[message.type].contentText  || message.message[message.type].title //|| message.message[Object.keys(message.message)[0]].text || message.message[Object.keys(message.message)[1]].text
